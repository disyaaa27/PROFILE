      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Text('Status Keaktifan', style: satu),
                SizedBox(
                  width: 195,
                ),
      ...
      home: Scaffold(
        body: SafeArea(
          ...
          children: [
            ...
            Column(
              children: [
                teks('Nama Lengkap', 'Dimas Nurdiansyah'),
                SizedBox(
                  height: 2,
                ),
                Divider(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Jl. Gintung RT.011/RW.002 Kel. Tanjung Barat Kec. Jagakarsa Jakarta Selatan',
                        style: empat,
                      ),
                    ],
                  ),
